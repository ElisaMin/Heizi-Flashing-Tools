...
//
//    override val partitions: MutableList<PartitionInfo>
//        get() = partitionInfo
//
//    override fun onInit() {
//        onGetvarMessage(message = fake)
//    }
//}

//val partitionInfo:MutableList<PartitionInfo> = mutableListOf()
//val deviceInfo = mutableStateMapOf<String,String>()
//private val deviceGetvar  get() = fake.lineSequence()
//private val allDeviceInfo get()  = deviceGetvar.map {
...
//    allDeviceInfo.forEach {
//    }
//    allDeviceInfo.filter {
//        it[0].startsWith("partition-")
//    }.forEach{ list ->
//        val ptsName = list[1]
...
//            else -> error(type)
//        }
//        PartitionInfo(name,pType,size)
//    }.let {
//        partitionInfo.clear()
//        partitionInfo.addAll(it)
//        partitionInfo.sortBy { it.name }
//    }
//}
